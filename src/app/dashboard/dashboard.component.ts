...
redirects;
  ...
  ngOnInit() {
      ...
      this.backconnector.getCounters('visit').then((result) => {
        console.log("here");
        console.log(JSON.parse(result._body));
this.visits = JSON.parse(result._body).response.count ;
    });
    this.backconnector.getCounters('redirection').then((result) => {
      console.log("here");
      console.log(JSON.parse(result._body));
